...
execute if score #IndividualDiff fkbm.options matches 1 if predicate fkbmtool:rng/10 run tag @s add fkbm.skeleton.firebomb
execute if score #IndividualDiff fkbm.options matches 1 run data merge entity @s {Health:20f,attributes:[{id:"minecraft:generic.max_health",base:20},{id:"minecraft:generic.armor",base:2},{id:"minecraft:generic.knockback_resistance",base:0.1},{id:"minecraft:generic.movement_speed",base:0.23}]}
...
execute if score #IndividualDiff fkbm.options matches 2 if predicate fkbmtool:rng/20 run tag @s add fkbm.skeleton.firebomb
execute if score #IndividualDiff fkbm.options matches 2 run data merge entity @s {Health:30f,attributes:[{id:"minecraft:generic.max_health",base:30},{id:"minecraft:generic.armor",base:4},{id:"minecraft:generic.knockback_resistance",base:0.2},{id:"minecraft:generic.movement_speed",base:0.26}]}
...
execute if score #IndividualDiff fkbm.options matches 3 if predicate fkbmtool:rng/30 run tag @s add fkbm.skeleton.firebomb
execute if score #IndividualDiff fkbm.options matches 3 run data merge entity @s {Health:40f,attributes:[{id:"minecraft:generic.max_health",base:40},{id:"minecraft:generic.armor",base:6},{id:"minecraft:generic.knockback_resistance",base:0.3},{id:"minecraft:generic.movement_speed",base:0.28}]}
