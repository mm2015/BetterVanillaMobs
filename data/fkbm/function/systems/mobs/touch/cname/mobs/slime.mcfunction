...
# type
execute run data modify storage fkbm:cname type.value set value "Slime"

## rarity/100
# skills
execute if entity @s[tag=fkbm.slime.fusion] run scoreboard players add #rarity fkbm.options 15
