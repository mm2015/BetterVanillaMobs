...
# type
execute run data modify storage fkbm:cname type.value set value "Hoglin"

## rarity/100
# skills
execute if entity @s[tag=fkbm.hoglin.hotblood] run scoreboard players add #rarity fkbm.options 3
execute if entity @s[tag=fkbm.hoglin.stomp] run scoreboard players add #rarity fkbm.options 15
